...
impl WarningMessage {
  ...
  pub fn message(self) -> &'static str {
    match self {
      ...
      WarningMessage::UnexpectedEndTagRewinding => "The end tag does not match the last start tag. Rewinding.",
      WarningMessage::UnexpectedEndTag => "An end tag was found with no preceeding start tag.",
